...
\label{sec:summary}
In less than 1000 characters (not counting spaces), with exactly one figure, explain the project goals and outcome which is accessible to an undergraduate student familiar with basic ML concepts.
